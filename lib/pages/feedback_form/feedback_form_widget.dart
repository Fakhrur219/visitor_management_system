...
class _FeedbackFormWidgetState extends State<FeedbackFormWidget> {
  ...
  void initState() {
    ...
    _model.bugsTextController ??= TextEditingController();
    _model.bugsFocusNode ??= FocusNode();
                      ...
                      children: [
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Container(
                                      width: 370.0,
                                      child: TextFormField(
                                        controller: _model.bugsTextController,
                                        focusNode: _model.bugsFocusNode,
                                        autofocus: true,
                        ...
                        Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              12.0, 12.0, 12.0, 5.0),
                          child: Text(
                            'Tell us your experience during your visit',
                            textAlign: TextAlign.start,
                            style: FlutterFlowTheme.of(context)
                                .labelMedium
                                .override(
                            ...
                            onPressed: () async {
                              await FeedbackRecord.collection
                                  ...
                                  .set(createFeedbackRecordData(
                                    ratingStar: _model.ratingBarValue?.round(),
                                    bugs: _model.bugsTextController.text,
                                    userExperience:
