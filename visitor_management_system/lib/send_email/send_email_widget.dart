...
class SendEmailWidget extends StatefulWidget {
  ...
  static String routeName = 'SendEmail';
  static String routePath = 'sendEmail';
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<MeetingsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<MeetingsRecord> sendEmailMeetingsRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final sendEmailMeetingsRecord = sendEmailMeetingsRecordList.isNotEmpty
            ? sendEmailMeetingsRecordList.first
            : null;
                              ...
                              children: [
                                      ...
                                      Padding(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              'Share necessary information to visitors',
                                ...
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 80.0, 0.0, 10.0),
                                  child: BarcodeWidget(
                                    data: sendEmailMeetingsRecord!.pageUrl,
                                ...
                                Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: TextFormField(
                                      controller:
                                          _model.meetingIDTextController ??=
                                              TextEditingController(
                                        text:
                                            sendEmailMeetingsRecord.meetingId,
                                      ),
