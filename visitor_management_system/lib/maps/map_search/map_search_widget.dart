...
class _MapSearchWidgetState extends State<MapSearchWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<MapsRecord>>(
      stream: queryMapsRecord(
        queryBuilder: (mapsRecord) => mapsRecord.orderBy('floor'),
      ),
      builder: (context, snapshot) {
        ...
        List<MapsRecord> mapSearchMapsRecordList = snapshot.data!;
                        ...
                        child: Column(
                          ...
                          children: [
                                        ...
                                        Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  1.0, 0.0, 0.0, 0.0),
                                          child: Text(
                                            'View directions to your meeting room',
                                            ...
                                            child: Padding(
                                              ...
                                              child: Autocomplete<String>(
                                                ...
                                                optionsBuilder:
                                                  ...
                                                  return mapSearchMapsRecordList
                                                      .map((e) => e.floor)
                                                      .toList()
                                                      .where((option) {
                            ...
                            if (!FFAppState().SearchActive)
                              Builder(
                                builder: (context) {
                                  final floorNoSearch = mapSearchMapsRecordList
                                      .toList()
                                      .take(3)
                                      .toList();
                                  ...
                                  return ListView.builder(
                                    ...
                                    itemCount: floorNoSearch.length,
                                    itemBuilder: (context, floorNoSearchIndex) {
                                      final floorNoSearchItem =
                                          floorNoSearch[floorNoSearchIndex];
                                      return Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            10.0, 12.0, 10.0, 10.0),
                                        child: InkWell(
